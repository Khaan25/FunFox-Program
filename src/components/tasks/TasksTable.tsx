...
export default function TasksTable() {
  ...
  return tasks === null || tasks.length === 0 ? (
    ...
    <Table className="max-h-[450px]">
      <TableCaption className="py-4">A list of your recent tasks.</TableCaption>
      <TableHeader>
        <TableRow>
        ...
        {Children.toArray(
          tasks.map((task) => (
            <TableRow>
              ...
              <TableCell className={cn("text-red-500", task.isCompleted && "text-green-500")}>{task.isCompleted ? "Completed" : "Incomplete"}</TableCell>
